...
set ONNX_MODEL="F:\StableDiffusion\Datasets\Z Tools\r3c-dataset-aio\Upscalers\4xNomos8kDAT.onnx"
set SCALE=1.5
:: --
...
if %ERRORLEVEL% == 0 (
    ...
    python ..\Utilities\ImageUpscaler.py --onnx_model %ONNX_MODEL% --input_dir %DATA_DIR% --output_dir %UPSCALE_DIR% --scale %SCALE%
