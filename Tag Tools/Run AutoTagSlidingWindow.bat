...
set DATA_DIR="F:\StableDiffusion\Datasets\2 Baking\Iwano_Kenta\1_Features"
set TRIGGER="@iwano kenta"
...
if %ERRORLEVEL% == 0 (
    ...
    python AutoTaggerExp.py --general_threshold=0.6 --character_threshold=0.65 --num_data_loader_workers="6" --mode_append --data_dir %DATA_DIR% --use_gpu
    REM --debug_print
